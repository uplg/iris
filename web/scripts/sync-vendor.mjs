...
const VENDOR = [
  ...
  },
  {
    ...
    expectMajor: 6,
    files: [
      ["dist/libav-6.8.8.0-default.wasm.js", "libavjs/libav-6.8.8.0-default.wasm.js"],
      ["dist/libav-6.8.8.0-default.wasm.mjs", "libavjs/libav-6.8.8.0-default.wasm.mjs"],
      ["dist/libav-6.8.8.0-default.wasm.wasm", "libavjs/libav-6.8.8.0-default.wasm.wasm"],
    ],
  },
];
